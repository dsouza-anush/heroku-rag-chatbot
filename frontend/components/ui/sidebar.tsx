    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        ...
        >
          ...
          <div data-slot="sidebar-inner" data-state="expanded" className="flex h-full w-full flex-col">
            {children}
          </div>
        </SheetContent>
      </Sheet>
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isOpen ? <PanelLeftIcon className="size-4" /> : <PanelRightIcon className="size-4" />}
